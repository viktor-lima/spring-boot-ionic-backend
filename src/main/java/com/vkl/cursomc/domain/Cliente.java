...
public class Cliente implements Serializable {
	...
	private List<Endereco> encerecos = new ArrayList<>();
	...
	public List<Endereco> getEncerecos() {
		return encerecos;
	}

	public void setEncerecos(List<Endereco> encerecos) {
		this.encerecos = encerecos;
	}
