...
import com.vkl.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instatiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "alemaojk249@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, coder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("12363323","93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "AnaCosta@gmail.com", "76401065488", TipoCliente.PESSOAFISICA, coder.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("58965659865","81935689498"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardin", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "sala 800", "centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "centro", "55649111", cli2, c2);
